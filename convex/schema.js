...
import { v } from "convex/values"; // v is a helper for defining the types of your data.
// it provides a set of validators that can be used to ensure the data being stored in the database is
// of the correct type.

// We import `defineSchema` to create the database schema,
// and export it as default so Convex can read and configure the database from this file.
